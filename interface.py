...
t0=np.array([0.1,0.2,0.3,0.4])#initial angles - can be random

result=minimize(costfn,t0,method="COBYLA") #optimizer - uses cobyla 

print(f"Ground state energy in Hatrees:{result.fun}")
print(f"Ground state energy in KJ/mol:{result.fun*2625.4996}")
fp=result.x # final parameters array
